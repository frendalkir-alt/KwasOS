...
ticks - Показать сколько тиков прошло с момента запуска,  
uptime - Показать сколько секунд прошло с момента запуска,  
cls - Очистить экран,  
reboot - Перезагрузить систему,  
shutdown - Выключить компьютер,  
panic - Искусственно вызвать панику ядра,  
Команды файловой системы:  
ls - Показать все файлы и директории на диске,  
cat - Показать содержимое файла,  
rm - Удалить файл,  
format - Форматировать диск (аккуратнее с этим)
